...
<table style="">
	<tr style="border:2px solid green;">
		<th>Serial</th>
		<th style="margin-left:6px;">Account ID</th>
		<th style="margin-left:6px;">Account Balance</th>
...
<?php 
	...
	$query_balance = "SELECT account_id,account_balance from members where member_id = '$memberId'";
	$result_balance = mysql_query($query_balance);
	while($row_data = mysql_fetch_array($result_balance)){
?>
	
	
	<tr style="border:2px solid green;">
		<td><?php echo ++$cnt; ?></td>
		<td style="margin-left:6px;"><?php echo $row_data['account_id']; ?></td>
		<td style="margin-left:6px;"><?php echo $row_data['account_balance']; ?></td>
	</tr>
<?php 
}
?>
