...
<div id="header" class="stretchX">
    ...
    <div id="company_name">Online Cafeteria Management</div>
</div>
<div id="center">
  <h1><center>Welcome To Online Cafeteria Management!</center></h1>
      <div class="body_text">
  Order your food today from Online Cafeteria and it will be delivered at your door step. Jump in to our weekly special deals in the Special Deals menu. Register an account with us to enjoy fast ordering, delivery, and convenient payment of your food. Start now by logging in below or registering if you don't have an account with us:
  </div>
            ...
            <form id="loginForm" name="loginForm" method="post" action="register-exec.php" onsubmit="return registerValidate(this)">
              <table width="450" border="0" align="center" cellpadding="2" cellspacing="0">
                ...
                <tr>
                  ...
                  <th>Account  ID(** Bkash Account) </th>
                  <td><font color="#FF0000">* </font><input name="account_id" type="text" class="textfield" id="account_id" /></td>
                </tr><tr>
                  <th>Account Balance </th>
                  <td><font color="#FF0000">* </font><input name="account_balance" type="text" class="textfield" id="account_balance" /></td>
                </tr>
                <tr>
...
<div id="footer">
  ...
  <div class="bottom_addr">&copy; 2015 Online Cafeteria Management. All Rights Reserved</div>
</div>
</div>
</body>
</html>
